...
const services = [
  ...
  },
  {
    ...
    title: "Shadow Hunt",
    description:
      "Step into the dim and quiet corners of the jungle, where elusive creatures roam under fading light.",
    icon: <Mountain size={24} />,
    image: "/captures/India Tiger/bengal-tiger-walking-in-jungle-india.webp", // Placeholder for Jungle
  },
  {
    id: 5,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <motion.div
            ...
            className="group relative h-80 overflow-hidden bg-black/20 hover:bg-black/40 transition-colors"
          >
            {/* Background Image */}
            ...
            <div className="relative z-10 p-8 h-full flex flex-col justify-between">
              <div className="flex justify-between items-start">
                <div className="bg-white/10 backdrop-blur-md p-3 text-white">
                  {service.icon}
                </div>
