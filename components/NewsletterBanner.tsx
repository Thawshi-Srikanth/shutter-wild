        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="relative w-full md:w-1/2 h-56 md:h-auto">
              <Image
                src="https://picsum.photos/id/1024/800/1000" // Example wildlife/nature image (eagle)
            ...
            <div className="relative w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <div className="mb-8">
                ...
                <h3 className="font-serif text-3xl md:text-4xl text-white mb-4 leading-tight">
                  ...
                  <span className="italic text-white/80">Wildest</span> Moments.
                </h3>
                <p className="text-sm text-white/60 leading-relaxed">
                  Sign up to receive stunning wildlife imagery, field notes, and
                  exclusive seasonal booking updates directly to your inbox.
                </p>
              </div>
